...
ACCESS_KEY = "ee9ef466-0d4dcedf-d193c5ea-6230a"
SECRET_KEY = "4f115721-90418c97-bf4b35ad-c55b9"
...
def api_key_get(params, request_path):
    ...
    timestamp = datetime.datetime(2018, 1, 15, 0, 0).strftime('%Y-%m-%dT%H:%M:%S')
...
def api_key_post(params, request_path):
    method = 'POST'
    timestamp = datetime.datetime.utcnow().strftime('%Y-%m-%dT%H:%M:%S')
    # timestamp = datetime.datetime(2017, 11, 30, 0, 0).strftime('%Y-%m-%dT%H:%M:%S')
